    ...
    <div className='flex flex-col gap-2'>
      ...
      <div className='w-full flex-col'>
        <div className='flex items-center gap-1 py-2'>
          ...
          <a className='underline' style={{fontSize: '10px'}} href={project.githubLink} target={"_blank"}>{project.githubLink}</a>
        </div>
        <div className='flex items-center gap-1'>
          ...
          <a className='underline' style={{fontSize: '10px'}} href={project.demoUrl} target={"_blank"}>{project.demoUrl}</a>
        </div>
      </div>
    </div>
  )
